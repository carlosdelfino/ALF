/*
 * ExceptionComponenteNaoAtivo.java Criado em 27/01/2004
 *
 ...
 * Nome: 
 */
public class ExceptionComponenteNaoAtivo extends Exception
{
	 ...
	 * @param p_msg
	 */
	public ExceptionComponenteNaoAtivo(String p_msg)
	{
		super(p_msg);
	}
}
