...
public class PrincipalWindows extends JFrame
{
	...
	private String TAB_GERENCIA_SIMULADOR = "Simulador de Falhas";
	...
	private javax.swing.JTextArea jTextAreaDominio = null;
	...
	public void abilitaTab(String p_tab)
	{
		...
		} else if (p_tab.equals(TAB_CANAIS))
		{
			...
			getJTextAreaDominio().setEnabled(true);
		}
	...
	{
		if (aca == null){
			aca = new AlgoritimoDeCorrelacaoDeAlarmes(getCanais().getCanais(),getSimulador().getAlarmesXML());
		}
		return aca;
	}
	/**
	 * 
	 */
	private SimuladorDeEmissaoDeAlarmes getSimulador()
	{
		if (simulador ==null){
			simulador = new SimuladorDeEmissaoDeAlarmes(getTopologia());
		}
		return simulador;
	}
	/**
	...
	private javax.swing.JScrollPane getJScrollPaneDominio() {
		if(jScrollPaneDominio == null) {
			try {
				...
				jScrollPaneDominio.setViewportView(getJTextAreaDominio());  // Generated
	...
	/**
	 * This method initializes jTextAreaDominio
	 * 
	 * @return javax.swing.JTextArea
	 */
	public javax.swing.JTextArea getJTextAreaDominio() {
		if(jTextAreaDominio == null) {
			try {
				jTextAreaDominio = new javax.swing.JTextArea();  // Generated
			}
			catch (java.lang.Throwable e) {
				//  Do Something
			}
		}
		return jTextAreaDominio;
	}
	/**
	...
	private PanelSimuladorDeAlarmes getPanelDoSimuladorDeFalhas()
	{
		if (panelSimulador == null){
			panelSimulador = new PanelSimuladorDeAlarmes();
			panelSimulador.setParente(this);
	...
	private javax.swing.JPanel getJPanelSimuladorFalhas() {
		if(jPanelSimuladorFalhas == null) {
			try {
				...
				jPanelSimuladorFalhas.add(getPanelDoSimuladorDeFalhas(), null);  // Generated
			}
			catch (java.lang.Throwable e) {
				//  Do Something
			}				jPanelSimuladorFalhas.add(getPanelDoSimuladorDeFalhas(), null);  // Generated
