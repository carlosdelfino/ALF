...
public class Alarme implements Evento, Comparable
{
	...
	public int compareTo(Object p_alarme)
	{
		 ...
		 */
		IdMas l_idComparado = ((Alarme)p_alarme).getIdMasOrigem();
		IdMas l_idBase = getIdMasOrigem();
	 ...
	 * @param p_mas
	 */
	private void setIdMasOrigem(IdMas p_idMas)
	{
		idMasOrigem = p_idMas;
	}
	/**
