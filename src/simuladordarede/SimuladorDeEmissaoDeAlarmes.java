...
import correlacaodealarmes.GeradorAutomaticoDeDominio;
import simuladordarede.erros.ExceptionCanaisNaoDefinidos;
import simuladordarede.erros.ExceptionComponenteNaoAtivo;
import simuladordarede.erros.ExceptionGADNaoDefinido;
...
public class SimuladorDeEmissaoDeAlarmes
{
	...
	/**
	 * Inicializa o simulador de Emissão de Alarmes
	 * @param p_topologia
	 * @param p_canais
	 * @param p_gad
	 */
	public SimuladorDeEmissaoDeAlarmes(Topologia p_topologia, GeradorAutomaticoDeDominio p_gad)
	{
		setTopologia(p_topologia);
		setCanais(p_topologia.getCanais());
	 ...
	 * @param p_gad
	 */
	private void setGAD(GeradorAutomaticoDeDominio p_gad)
	{
		gad = p_gad;
	 ...
	 * @param p_canais
	 */
	private void setTopologia(Topologia p_topologia)
	{
	...
	private void makeAlarmesFalsos()
	{
		...
		if (maxFalhas > 0)
			// enquanto o numero de ramdomico estiver abaixo do minimo
			// ele irá regerar, o maximo está limitado como argumento 
			// do metodo nextInt do objeto random.		
			do
			{
				l_QtdAlarmes = random.nextInt(maxFalhas);
			} while (l_QtdAlarmes < minFalhas);
		else
			// se eu tiver o maximo de falhas como 0, ele não sa o objeto random
			l_QtdAlarmes = 0;
	 ...
	 * @param p_i
	 */
	public void setMaxFalhas(int p_i) throws ExceptionMaximoMenorMinimo
	{
		if (minFalhas > p_i)
	 ...
	 * @param p_i
	 */
	public void setMinFalhas(int p_i)
	{
		minFalhas = p_i;
		maxFalhas = maxFalhas < minFalhas ? minFalhas : maxFalhas;
	}
